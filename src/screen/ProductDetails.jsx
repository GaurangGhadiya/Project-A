    ...
    <SafeAreaView>
      <>
        <ScrollView style={styles.main}>
          ...
          <View style={styles.offers}>
            ...
            <Text style={styles.offersShoryDesc2}>
              Use code PROJECT10 to get flat 10% off on minimum order of
        ...
        <View style={styles.fixedBtns}>
          <TouchableOpacity
          //   onPress={() => navigation.navigate('WishlistMain')}
          >
            <View
              flex={1}
              textAlign="center"
              ...
              alignItems="center"
              flexDirection="row">
              <Icon name={'cards-heart-outline'} size={24} color={'#222222'} />
              <Text style={styles.fixedText1}>WISHLIST</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('CartMain')}>
            <View
              ...
              <Text style={styles.fixedText}>ADD TO BAG</Text>
            </View>
          </TouchableOpacity>
        </View>
      </>
