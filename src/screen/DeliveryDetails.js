        ...
        <ScrollView style={styles.main}>
          ...
          <View style={styles.address}>
                ...
                <View style={styles.card}>
                  ...
                  <View style={styles.addright}>
                    <View style={styles.addtop}>
                      <Text style={styles.addName}>Carolina S Seo</Text>
                      <View style={styles.addTypeOut}>
                        <Text style={styles.addType}>HOME</Text>
                      </View>
                    </View>
                    <View>
                      <Text style={styles.addLine}>
                        B-301, Shangrila Heights, VIP Circle, Uttran, Surat,
                        394105
                      </Text>
                    </View>

                    <View style={styles.phone}>
                      <Text style={styles.phoeText}>Phone No.</Text>
                      <Text style={styles.phoneno}>+91 9061-93206</Text>
                    </View>
                  </View>
                </View>
              </>
            ...
            <View style={styles.btn}>
                <Text style={styles.btnText}>Change or Add New Address</Text>
            </View>
          </View>

          <View style={styles.expacted}>
            <Text style={styles.expactedtext}>Expected Delivery</Text>
...
<View style={styles.expRight}>
    <Text style={styles.itemName}>Pink Hoddie T-shirt</Text>
    <View style={styles.rightTop}>
        <Text style={styles.by}>Delivery By{" "}</Text>
        <Text style={styles.date}>25th July</Text>
    </View>
</View>
            </View>
            </>)}
        ...
        <View style={styles.bottomPrice}>
              ...
              <TouchableOpacity style={styles.bottomPriceRight} onPress={() => navigation.navigate('PaymentDetails')}>
                <Text style={styles.bottomPriceRightText}>Proceed to Payment</Text>
              </TouchableOpacity>
        </View>
      </SafeAreaView>
    </>
