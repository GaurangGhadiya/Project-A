      ...
      <SafeAreaView>
        <ScrollView style={styles.main}>
          ...
          <View style={styles.topIcon}>
            <Image
              source={{
                uri: 'https://themes.pixelstrap.com/multikart-app/assets/images/check-circle.gif',
              }}
              style={styles.gif}
            />
          </View>
          <View style={styles.success}>
            <Text style={styles.orederText}>Order successfully!</Text>
            <Text style={styles.orederdesc}>
          ...
          <View style={styles.details}>
            ...
            <View style={styles.return}>
              <Text style={styles.offersLabel}>Your order # is: 64484032 </Text>
              ...
              <Text style={styles.returnDesc1}>3501 Maloy Court,</Text>

              <Text style={styles.returnDesc1}>East Elmhurst, New York City</Text>

              <Text style={styles.returnDesc1}>11369</Text>

              <Text style={styles.offersLabel}>Payment Method </Text>
              <Text style={styles.returnDesc1} marginBottom={30}>Google UPI</Text>
            </View>
          </View>
          ...
          <View marginTop={-5}>
            ...
            />
            <View marginLeft={15}>
              <Text style={styles.prodName}>Men Blue Denim Jacket</Text>
              <View style={styles.prodHor}>
                <Text style={styles.prodSize}>Size: M</Text>
                <Text style={styles.prodQty}>Qty: 1</Text>
              </View>
              <Text style={styles.prodPrice}>₹99.00</Text>
            </View>
            </View>
            </>)}
          </View>
        ...
        <View style={styles.bottomPrice}>
              <View >
                ...
                <TouchableOpacity ><Text  style={styles.bottomPriceDetails}>Track Order</Text></TouchableOpacity>
              </View>
              <TouchableOpacity style={styles.bottomPriceRight} onPress={() => navigation.navigate('Shop')}>
                <Text style={styles.bottomPriceRightText}>Continue Shopping</Text>
              </TouchableOpacity>
        </View>
      </SafeAreaView>
    </>
